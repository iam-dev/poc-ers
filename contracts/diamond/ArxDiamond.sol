...
/**
 * @title Arx "Diamond" proxy reference implementation
 */
abstract contract ArxDiamond is
    ISolidStateDiamond,
    DiamondBase,
    DiamondFallback,
    DiamondReadable,
    ...
    ERC165Base
{
    ...
    function __ArxDiamond_init(address owner_) internal {
        ...
        // set owner
        OwnableStorage.layout().owner = owner_;
    }
