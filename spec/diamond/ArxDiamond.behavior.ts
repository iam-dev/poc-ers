...
} from "@solidstate/spec/dist/access";
import { describeBehaviorOfERC165Base } from "@solidstate/spec/dist/introspection";
import {
  describeBehaviorOfDiamondBase,
  DiamondBaseBehaviorArgs,
} from "@solidstate/spec/dist/proxy/diamond/base/DiamondBase.behavior";
import {
  describeBehaviorOfDiamondFallback,
  DiamondFallbackBehaviorArgs,
} from "@solidstate/spec/dist/proxy/diamond/fallback/DiamondFallback.behavior";
import {
  describeBehaviorOfDiamondReadable,
  DiamondReadableBehaviorArgs,
} from "@solidstate/spec/dist/proxy/diamond/readable/DiamondReadable.behavior";
import {
  describeBehaviorOfDiamondWritable,
  DiamondWritableBehaviorArgs,
} from "@solidstate/spec/dist/proxy/diamond/writable/DiamondWritable.behavior";
import {
  deployMockContract,
  MockContract,
...
import { IArxDiamond } from "@arx/typechain-types";
import { expect } from "chai";
import { ethers } from "hardhat";

export interface ArxDiamondBehaviorArgs
...
export function describeBehaviorOfSolidStateDiamond(
  deploy: () => Promise<IArxDiamond>,
  args: ArxDiamondBehaviorArgs,
  skips?: string[]
) {
